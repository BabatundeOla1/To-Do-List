...
import static com.theezy.utils.mapper.ToDoListMapper.mapRequestToToDoList;
...
class ToDoListServiceImplTest {
    ...
    public void testThatYouCanSearchForToDoListUsingTitle(){
        ...
        assertEquals(secondToDoList, toDoListService.searchWithTitle(secondToDoList.getTitle()));
    }
}